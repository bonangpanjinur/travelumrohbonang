...
- [Unsanitized dangerouslySetInnerHTML stored XSS](unsanitized-html-stored-xss.md) — any DB-stored HTML rendered via `dangerouslySetInnerHTML` must be sanitized with dompurify.
...
- [Project structure after re-import cleanup](project-structure-cleanup.md) — after each Replit re-import, .migration-backup/ contains the real app; extract it, create docs/, and delete .migration-backup/.
