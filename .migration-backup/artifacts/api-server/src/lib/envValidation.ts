...
const ENV_SPEC: EnvSpec[] = [
  ...
  { key: "RESEND_API_KEY",            required: false, description: "Resend API key for transactional email (F-03)" },
  { key: "EMAIL_FROM",                required: false, description: "Sender email address for transactional email" },
  { key: "EMAIL_FROM_NAME",           required: false, description: "Sender display name for transactional email" },
];
