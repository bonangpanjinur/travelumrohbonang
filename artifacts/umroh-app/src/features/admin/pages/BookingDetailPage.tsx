    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="bg-card border border-border rounded-xl px-5 py-4 space-y-3">
        ...
        <nav className="flex items-center gap-1.5 text-sm text-muted-foreground">
          <Link to="/admin/bookings" className="hover:text-foreground transition-colors">Booking</Link>
          <span>/</span>
          <span className="font-mono text-foreground font-medium">{booking.bookingCode}</span>
        </nav>
      ...
      <div className="bg-card border border-border rounded-xl p-5">
        <h3 className="font-semibold text-sm flex items-center gap-2 mb-4">
          <User className="w-4 h-4 text-primary" /> Data Pemesan &amp; Penginput
        </h3>
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-3 text-sm">
          {/* Pemesan akun */}
          <div>
            <p className="text-xs text-muted-foreground font-medium mb-0.5">Pemesan (Akun)</p>
            <p className="font-medium">{booking.user?.name || booking.pemesanName || "-"}</p>
          ...
          {(booking.pemesanPhone || booking.picPhone) && (
            <div>
              <p className="text-xs text-muted-foreground font-medium mb-0.5">No. HP</p>
              <div className="flex items-center gap-2">
          ...
          {booking.isGroupBooking && booking.groupName && (
            <div>
              <p className="text-xs text-muted-foreground font-medium mb-0.5">Rombongan</p>
