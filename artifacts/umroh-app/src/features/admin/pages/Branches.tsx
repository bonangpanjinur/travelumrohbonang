            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <section className="space-y-3">
                ...
                <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                  ...
                  <div><Label>Kode Cabang <span className="font-normal text-muted-foreground">(opsional)</span></Label><Input value={form.code} onChange={(e) => setForm({ ...form, code: e.target.value.toUpperCase().replace(/[^A-Z0-9-]/g, "") })} placeholder="Otomatis dari nama cabang" className="mt-1 font-mono" /><p className="mt-1 text-[11px] text-muted-foreground">Kosongkan untuk generate otomatis dari nama. Tetap bisa disesuaikan, misalnya <b>BDG</b>.</p></div>
                </div>
