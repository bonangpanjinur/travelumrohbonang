...
export const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Dokumen Jemaah", href: "/admin/documents", icon: FileCheck },
    ],
  },
  {
    label: "Keuangan",
    items: [
      ...
      { label: "Akuntansi & Keuangan", href: "/admin/accounting", icon: BarChart3 },
      { label: "Payment Gateway", href: "/admin/payment-gateway", icon: Wallet },
  ...
  },
  {
    label: "Pemasaran",
    items: [
      { label: "CRM & Follow-up", href: "/admin/crm", icon: MessageCircle },
      ...
      { label: "Analitik AI", href: "/admin/analytics-ai", icon: BrainCircuit },
    ],
  },
  {
    label: "Master Data",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Multi-Bahasa", href: "/admin/multi-language", icon: Languages },
