...
const Navbar = () => {
  ...
  const handleLogout = async () => {
    ...
    { id: "agen", label: "Agen", url: "/agen", parent_id: null, sort_order: 3, open_in_new_tab: false },
    { id: "jadwal", label: "Jadwal", url: "/jadwal", parent_id: null, sort_order: 4, open_in_new_tab: false },
    { id: "3", label: t("nav.gallery"), url: "/galeri", parent_id: null, sort_order: 5, open_in_new_tab: false },
    { id: "4", label: t("nav.blog"), url: "/blog", parent_id: null, sort_order: 6, open_in_new_tab: false },
