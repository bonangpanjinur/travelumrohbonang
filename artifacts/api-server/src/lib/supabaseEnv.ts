 ...
 * fallback ke `VITE_SUPABASE_URL`/`VITE_SUPABASE_ANON_KEY` atau
 * `VITE_SUPABASE_PUBLISHABLE_KEY` (variabel publik yang digunakan Supabase).
 * Isi salah satu saja.
 *
 ...
 * ter-bundle ke frontend publik jika demikian). `VITE_SUPABASE_PUBLISHABLE_KEY`
 * tetap aman digunakan sebagai anon/public key, bukan sebagai service-role key.
 */
